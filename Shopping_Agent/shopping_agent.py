...
def search_products(query: str, max_price: Optional[float] = None, is_organic: Optional[bool] = None) -> str:
    """
    Search the product in database by keyword (name, description, and category).
    ...
    is_organic: Boolean only.
            Use true or false.
            Do NOT pass "True" or "False" as strings.
    """
...
# ----------------------------------  Agent --------------------------------------------
# the prompt used is after multiple iterations of testing and refining to ensure the agent behaves as expected in a shopping context.
...
if __name__ == "__main__":
            ...
            "messages": [
                {
                    "role": "user",
                    "content": (
                        "I want to buy tiger with 4.5+ rating and less than $20 price."
                    ),
                }
            ]
        }
    ...
    # image_path = os.path.join("images", "oats.png")
    # result = describe_product_image(image_path)
    #print(result)